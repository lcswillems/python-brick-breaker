...
class Editor(tk.Canvas):
    ...
    #If the "X.txt" file (with X the level number) exists, level bricks are placed in the window and white bricks correspond to "."
    ...
    #changes the bricks color and saves the new grid in the "X.txt" file (with X the level number)
    #where white bricks are replaced with "."
...
#The brick clicked takes the color of the selected brick
#Or, if cursor is on one of bricks at the bottom of screen, it is selected
...
#The bricked clicked becomes white
