...
class Game(tk.Canvas):
    ...
    def moveBall(self):
        ...
        #Collisisons computation between ball and bricks
        i = 0
    ...
    #This method, called at each frame, manages the remaining time for each of effects and displays them (bar and ball size...)
    def updateEffects(self):
        ...
        #"shield" effect allows the ball to bounce once at the bottom of the screen (it's like an additional life)
        if self.effects["shield"][0]:
